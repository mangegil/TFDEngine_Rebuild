...
namespace REL
{
	...
	public:
		...
		{
			return (static_cast<uint8_t>(GetRuntime()) & static_cast<uint8_t>(Runtime::AE)) != 0;
		}
		...
		{
			return (static_cast<uint8_t>(GetRuntime()) & static_cast<uint8_t>(Runtime::SE)) != 0;
		}
		...
		[[nodiscard]] static SKYRIM_REL_VR bool IsVR() noexcept
		{
			...
			return true;
#else
			return (static_cast<uint8_t>(GetRuntime()) & static_cast<uint8_t>(Runtime::VR)) != 0;
#endif
		}
